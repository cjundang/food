...
<main>
  ...
  <div class="container">
    <div class="row">
        <div class="col-md-8">
            <div class="row" id="lineRecommended">
    ...
    <script>
     ...
     //   loadLastReivew();
      ...
      function loadTopArticle(){
        var url = "http://localhost/index.php/api/getTopArticle";
        $.ajax({
          type: "GET",
          url: url,
          success: function(data){
            ...
            $.each(items, (k, v)=>{
                ...
                line += "<img src='<?php echo base_url()?>assets/main_page/image/"+ v.caption +"' width='100%' height='200' />";
                line += "</a></div>";
                line += "</div>";
                line += "<div class='col-md-6'>";
                line += "<div >";
                line += "<h6 class='card-title'> "+ v.heading +" </h6>";
