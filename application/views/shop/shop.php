  ...
  <div class="row">
    ...
    <script>
      ...
      function loadLastArticle(){
        var url = "<?php echo site_url("shopapi/getTopShops")?>";
        $.ajax({
          type: "GET",
          url: url,
          success: function(data){
            ...
            $.each(items, (k, v)=>{
              ...
              line += "<div class='card'>"; 
              line += "<a href='"+ v.link +"'><img src='<?php echo base_url()?>assets/"+ v.caption+"' width='100%' height='200'></a>";
              ...
              line += "<p class='card-text'><div class='my-rating jq-stars' data-rating='"+ v.point+"'></div>"+v.ratting+" เรตติ้ง ("+v.review+" รีวิว) </p>";
              line += "</div></div></div>";
            });
      ...
      function loadTopFourCafe(){
        var url = "<?php echo site_url("api/getTopFourCafe")?>";
        $.ajax({
          type: "GET",
          url: url,
          success: function(data){
      ...
      function loadTopEightRecommend(){
        var url = "<?php echo site_url("api/getTopEightRecommend")?>";
        $.ajax({
          type: "GET",
          url: url,
          success: function(data){
      ...
      function loadLastSixCafe(){
        ...
        var url = "<?php echo site_url("api/getLastSixCafe")?>";
        $.ajax({
          type: "GET",
          url: url,
          success: function(data){
      ...
      function loadLastReivew(){
        ...
        var url = "<?php echo site_url("api/getLastReivew")?>";
        $.ajax({
          type: "GET",
          url: url,
          success: function(data){
