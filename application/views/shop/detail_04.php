        ...
        <div class="col-md-9">
            <div class="row" style="margin-top:20px;border: 2px solid orange;border-radius:10px; padding:10px; width:100%">
                <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-7">
                      <img src="<?php echo base_url()?>assets/upload/shop/1004/shop-021.jpeg" width="100%" height="100%">
                      </div>
                      <div class="col-md-5">
                      <div class="row">
                      <div class="col-md-12"><img src="<?php echo base_url()?>assets/upload/shop/1004/shop-020.jpeg" width="100%" height="100%"></div>
                      <div class="col-md-12"><img src="<?php echo base_url()?>assets/upload/shop/1004/shop-018.jpeg" width="100%" height="100%"></div>
                      </div>
                      </div>
                    </div>
                    <h4 id="heading">ชาวเรือ</h4>
                    <div class="row">
