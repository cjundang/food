...
<!--    
        ...
        <div class="col-md-9">
            <div class="row" style="margin-top:20px;border: 2px solid orange;border-radius:10px; padding:10px; width:100%">
                <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-7">
                      <img src="<?php echo base_url()?>assets/upload/shop/1003/shop-014.jpeg" width="100%" height="100%">
                      </div>
                      <div class="col-md-5">
                      <div class="row">
                      <div class="col-md-12"><img src="<?php echo base_url()?>assets/upload/shop/1003/shop-016.jpeg" width="100%" height="100%"></div>
                      <div class="col-md-12"><img src="<?php echo base_url()?>assets/upload/shop/1003/shop-015.jpeg" width="100%" height="100%"></div>
                      
                      </div>
                      </div>
                    </div>
                    <h4 id="heading">ครัวนายหนัง</h4>
                    <div class="row">
            ...
            <div class="row" style="margin-top:10px;border: 2px solid orange;border-radius:10px; padding:10px; width:100%">
              ...
              <h5>เมนูแนะนำ</h5>
                  ...
                  <div class="col-md-4">
                      ...
                      <img src="<?php echo base_url()?>assets/upload/shop/1001/4-001.jpeg" class="card-img-top" alt="..." >
                        <div class="card-body">
                          <p class="card-text">ขนมกวนขาว</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="card" style="width: 18rem;">
                      <img src="<?php echo base_url()?>assets/upload/shop/1001/4-002.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                          <p class="card-text">ขนมจีน</p>
                        </div>
                      </div>
                    </div>    
                    <div class="col-md-4">
                      <div class="card" style="width: 18rem;">
                      <img src="<?php echo base_url()?>assets/upload/shop/1001/4-003.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                          <p class="card-text">มังคุดคัด</p>
                        </div>
                      </div>
                    </div>    
            ...
            <div class="row" style="margin-top:10px;border: 2px solid orange;border-radius:10px; padding:10px; width:100%">
                <div class="col-md-12">
                    ...
                    <div class="row">
                    <div class="col-md-3">
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3874.8712803858416!2d100.64784541485533!3d13.786632200199707!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x311d6224d2cea611%3A0xe4d97cc833b03f2c!2z4LiC4LiZ4Lih4LiI4Li14LiZ4LmA4Lih4Li34Lit4LiH4LiE4Lit4LiZ!5e0!3m2!1sth!2sth!4v1621360579029!5m2!1sth!2sth" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                    <div class="col-md-9">
                      <ul class="list-group">                      
                        <li class="list-group-item">
                        <a href="https://www.google.com/maps/dir/8.4457368,99.9620758/%E0%B8%82%E0%B8%99%E0%B8%A1%E0%B8%88%E0%B8%B5%E0%B8%99%E0%B9%80%E0%B8%A1%E0%B8%B7%E0%B8%AD%E0%B8%87%E0%B8%84%E0%B8%AD%E0%B8%99+%E0%B8%99%E0%B8%84%E0%B8%A3%E0%B8%A8%E0%B8%A3%E0%B8%B5/@8.4304448,99.9548168,15z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x305301131a0acd65:0x72230dfe57d9f0f1!2m2!1d99.9670796!2d8.4156158" target="_blank">
  ...
  <path fill-rule="evenodd" d="M4 4a4 4 0 1 1 4.5 3.969V13.5a.5.5 0 0 1-1 0V7.97A4 4 0 0 1 4 3.999z"/>
                          ...
                          <div class="col-md-8"><i class="bi bi-pin-map-fill"></i>ถนนราชดำเนิน นครศรีธรรมราช (วิ่งเส้นราชดำเนิน ผ่านหอนาฬิกา เลี้ยวเข้าซอยพานยม)</div>
